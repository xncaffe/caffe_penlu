#ifndef CAFFE_PENLU_LAYER_HPP_
#define CAFFE_PENLU_LAYER_HPP_
...
class PENLULayer : public NeuronLayer<Dtype> {
 public:
  /**
   ...
   */
  explicit PENLULayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "PENLU"; }
 ...
 protected:
  ...
  /**
   * @brief Computes the error gradient w.r.t. the PENLU inputs.
   *
